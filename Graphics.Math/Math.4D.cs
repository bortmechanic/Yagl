...
namespace Yagl.Graphics
{
    public partial class Math
    {
        ...
        {
            return new Matrix4f(
                m.M11 / (float) a, m.M12 / (float) a, m.M13 / (float) a, m.M14 / (float) a,
        ...
        {
            var st = new Matrix4d(
                m.M22 * m.M33 * m.M44 + m.M32 * m.M43 * m.M24 + m.M23 * m.M34 * m.M42 -
                m.M42 * m.M33 * m.M24 - m.M43 * m.M34 * m.M22 - m.M32 * m.M23 * m.M44,
                -m.M12 * m.M33 * m.M44 - m.M32 * m.M43 * m.M14 - m.M13 * m.M34 * m.M42 +
                m.M42 * m.M33 * m.M14 + m.M43 * m.M34 * m.M12 + m.M32 * m.M13 * m.M44,
                m.M12 * m.M23 * m.M44 + m.M22 * m.M43 * m.M14 + m.M13 * m.M24 * m.M42 -
                m.M42 * m.M23 * m.M14 - m.M43 * m.M24 * m.M12 - m.M22 * m.M13 * m.M44,
                -m.M12 * m.M23 * m.M34 - m.M22 * m.M33 * m.M14 - m.M13 * m.M24 * m.M32 +
                m.M32 * m.M23 * m.M14 + m.M33 * m.M24 * m.M12 + m.M22 * m.M13 * m.M34,

                -m.M21 * m.M33 * m.M44 - m.M31 * m.M43 * m.M24 - m.M23 * m.M34 * m.M41 +
                m.M41 * m.M33 * m.M24 + m.M43 * m.M34 * m.M21 + m.M31 * m.M23 * m.M44,
                m.M11 * m.M33 * m.M44 + m.M31 * m.M43 * m.M14 + m.M13 * m.M34 * m.M41 -
                m.M41 * m.M33 * m.M14 - m.M43 * m.M34 * m.M11 - m.M31 * m.M13 * m.M44,
                -m.M11 * m.M23 * m.M44 - m.M21 * m.M43 * m.M14 - m.M13 * m.M24 * m.M41 +
                m.M41 * m.M23 * m.M14 + m.M43 * m.M24 * m.M11 + m.M21 * m.M13 * m.M44,
                m.M11 * m.M23 * m.M34 + m.M21 * m.M33 * m.M14 + m.M13 * m.M24 * m.M31 -
                m.M31 * m.M23 * m.M14 - m.M33 * m.M24 * m.M11 - m.M21 * m.M13 * m.M34,

                m.M21 * m.M32 * m.M44 + m.M31 * m.M42 * m.M24 + m.M22 * m.M34 * m.M41 -
                m.M41 * m.M32 * m.M24 - m.M42 * m.M34 * m.M21 - m.M31 * m.M22 * m.M44,
                -m.M11 * m.M32 * m.M44 - m.M31 * m.M42 * m.M14 - m.M12 * m.M34 * m.M41 +
                m.M41 * m.M32 * m.M14 + m.M42 * m.M34 * m.M11 + m.M31 * m.M12 * m.M44,
                m.M11 * m.M22 * m.M44 + m.M21 * m.M42 * m.M14 + m.M12 * m.M24 * m.M41 -
                m.M41 * m.M22 * m.M14 - m.M42 * m.M24 * m.M11 - m.M21 * m.M12 * m.M44,
                -m.M11 * m.M22 * m.M34 - m.M21 * m.M32 * m.M14 - m.M12 * m.M24 * m.M31 +
                m.M31 * m.M22 * m.M14 + m.M32 * m.M24 * m.M11 + m.M21 * m.M12 * m.M34,

                -m.M21 * m.M32 * m.M43 - m.M31 * m.M42 * m.M23 - m.M22 * m.M33 * m.M41 +
                m.M41 * m.M32 * m.M23 + m.M42 * m.M33 * m.M21 + m.M31 * m.M22 * m.M43,
                m.M11 * m.M32 * m.M43 + m.M31 * m.M42 * m.M13 + m.M12 * m.M33 * m.M41 -
                m.M41 * m.M32 * m.M13 - m.M42 * m.M33 * m.M11 - m.M31 * m.M12 * m.M43,
                -m.M11 * m.M22 * m.M43 - m.M21 * m.M42 * m.M13 - m.M12 * m.M23 * m.M41 +
                m.M41 * m.M22 * m.M13 + m.M42 * m.M23 * m.M11 + m.M21 * m.M12 * m.M43,
                m.M11 * m.M22 * m.M33 + m.M12 * m.M23 * m.M31 + m.M21 * m.M32 * m.M13 -
                m.M31 * m.M22 * m.M13 - m.M21 * m.M12 * m.M33 - m.M32 * m.M23 * m.M11);
